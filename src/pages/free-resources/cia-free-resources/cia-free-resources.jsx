        ...
        {visible.distractor && (
          <Suspense fallback={null}>
            <FreeResourceDistractor
              course="CIA"
              heading="CIA Free Distractor - Section Wise"
              subHeading="Select any module to access free distractors that help you test your knowledge, identify common mistakes, improve concept clarity, and strengthen your CIA preparation."
            />
          </Suspense>
        )}
      </div>
