...
const HOME_FALLBACK_ANNOUNCEMENTS = [
  ...
  },
  {
    ...
    subtext:
      "We've got you covered. Crack CFE with AIA's 250 pages quick notes.",
    link: "cfe-curriculum",
  },
  {
    id: 6,
          ...
          <>
            ...
            <div className="lg:absolute lg:w-[500px] lg:bottom-0 lg:left-5 lg:z-20 lg:translate-y-1/2">
              ...
              <div className="bg-gray-200 shimmer">
                ...
                <div className="px-3 sm:px-4 pb-3 flex items-center justify-between gap-2 overflow-hidden border-t border-gray-300/30 pt-2">
                  <div className="w-10 h-2.5 bg-gray-300 rounded shrink-0" />
                  <div className="flex min-w-0 flex-1 items-center justify-center gap-1 sm:gap-2 overflow-hidden">
                    {/* Fixed-width dot containers — matches the real dots fix */}
                    <div className="w-3 sm:w-4 h-[3px] bg-gray-300 rounded-full" />
                    <div className="w-3 sm:w-4 h-[3px] bg-gray-300 rounded-full" />
                    <div className="w-3 sm:w-4 h-[3px] bg-gray-300 rounded-full" />
                  </div>
    ...
    <>
      ...
      <section className="relative">
        ...
        {current != null && bottombar && (
          <div className="lg:absolute lg:w-125 lg:bottom-5 lg:left-5 lg:z-20 lg:translate-y-1/2">
            <div className="h-0.75 bg-linear-to-r from-[#F3831C] via-[#F3831C]/70 to-transparent" />
            ...
            <div className="bg-black/85 backdrop-blur-md border border-t-0 border-white/10">
              ...
              <div className="px-3 sm:px-4 pb-1 flex items-center justify-between gap-2 border-t border-white/5 pt-2 overflow-hidden">
                <span className="shrink-0 text-[10px] font-mono text-white/70 tracking-widest uppercase">
                ...
                <div className="flex min-w-0 flex-1 items-center justify-center gap-1 sm:gap-2 overflow-hidden">
                  {announcements.map((_, index) => (
                    <button
                      ...
                      className="min-h-6 w-4 sm:w-6 shrink flex items-center justify-center overflow-hidden"
                      aria-current={index === currentSlide ? "true" : undefined}
                    >
                      <span
                        className="h-[3px] w-3 sm:w-4 overflow-hidden rounded-full"
                ...
                <div className="flex shrink-0 items-center gap-0.5">
                  <button
                    ...
                    className="min-h-9 min-w-9 sm:min-h-11 sm:min-w-11 flex items-center justify-center
